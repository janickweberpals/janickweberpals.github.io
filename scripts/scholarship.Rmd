...
* Name: **`r gs_profile$name`**
* Current affiliation: `r gs_profile$affiliation`
* Citations total: `r gs_profile$total_cites` citations (details on publications can be found in [Publications](https://janickweberpals.github.io/files/publications.html)
